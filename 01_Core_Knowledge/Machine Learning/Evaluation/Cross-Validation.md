...
1. Sau $K$ lần lặp, tính giá trị trung bình (Mean) và độ lệch chuẩn (Standard Deviation) của chỉ số đánh giá (như Accuracy, F1-score từ [[Classifier Metric]]) qua $K$ lần chạy.
